...
void selectRadio() {
  digitalWrite(WIFI_SHIELD_CS, HIGH);
  //delay(100);
...
void selectWiFi() {
  ...
  //delay(100);
  digitalWrite(WIFI_SHIELD_CS, LOW);
  //delay(100);
}
...
//		Serial.print(freeMemory(), DEC);  // print how much RAM is available.
		...
		if ((eventData.cubeID == 80) || (eventData.cubeID == 42)) // Only Maze and Turntable forwarded to Splunk
